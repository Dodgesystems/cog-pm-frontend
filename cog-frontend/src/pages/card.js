...
const card = () => {
  return (
    ...
    <div className="carde relative">
     ...
     className="imi"
     />
     <span className="absolute top-2 left-1"  > <Image  src={camera} /></span>
     <span className="absolute bottom-0 left-0 bg-[#62909F] text-white text-sm w-32 h-8  text-center pt-1"  >Apartment</span>
    </div>
    ...
    <div className="flex w-full  justify-between  ">
     ...
     <div className="mt-5">  <AiOutlineHeart/>  </div>
    </div>

    <div className="flex justify-between p-2 ml-2 ">
     <div className="flex "> <Image src={Bed}   /> <span className="ml-3">2</span> </div>
     <div  className="flex"> <Image src={hex}  /> <span className="ml-3">2</span> </div>
     <div className="flex"> <Image src={Toilet}  /> <span className="ml-3">2</span> </div>
