...
import { offline, offers } from '../../Data/placeholder'
        ...
        <section className="p-8">
            <header className="flex items-center justify-between">
                <div>
                    ...
                    <h3 className="text-xl font-semibold opacity-50 mt-4">All agreements</h3>
                </div>
            ...
            <div className="border rounded-lg my-8 p-6">
                ...
                <div className="grid grid-cols-5 mt-10 font-bold">
                    <div className="flex items-center">
                        <input ref={checkRef} type="checkbox" className="cursor-pointer [&:not(input:checked)]:appearance-none outline-none accent-primary h-5 w-5 border border-primary rounded-sm mr-2" />
