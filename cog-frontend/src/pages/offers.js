                ...
                <section className="mt-5 pr-5">
                    <div className="flex">
                        <div className="relative ml-auto">
                            <button className="bg-[#386A8B] text-white rounded-[4px] px-6 py-2 ml-auto" onClick={togglePopupHandler}>Manage offers</button>
                    ...
                    <div className="pt-10 flex justify-between gap-x-5">
                        ...
                        <div className="w-full max-w-[367px] bg-[#386A8B] border-2 border-[#386A8B] p-5 text-white border-2">
                            ...
                            <h1 className="font-bold text-[32px] mt-6 mb-8">15</h1>
                                ...
                                <div className="px-10 py-5 grid grid-cols-2 gap-x-10">
                                    <div>
                                        <div className="max-w-[30rem] text-center pt-20 text-[#4B4B4B]">
                                            <h1 className='font-bold mb-10'>You have no previous offers</h1>
                                            <p>Create a new offers by through the Offers manager dropdown</p>
                                            <p>Go to Offers manager &gt; Add new offer.</p>
                                        </div>
                                    </div>
                                    <figure>
