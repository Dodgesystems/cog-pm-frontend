            ...
            [...Array(4)].map((_, i) => (
                <div key={i} className="flex gap-x-10 p-4 border-b-[#E8E8EE] border-b-2 mr-10">
                    ...
                    <div className="flex flex-col gap-y-3">
                        <h1 className="text-[#19191A] text-[18px] font-semibold">Agreement with  Ajibola Quadri for Ikorodu property</h1>
                ...
                <section className="mt-5 pr-5">
                    <div className="flex">
                        <div className="relative ml-auto">
                            <button className="bg-[#386A8B] text-white rounded-[4px] px-6 py-2 ml-auto" onClick={togglePopupHandler}>Manage agreements</button>

                            {
                                openPopup && <div className="absolute right-0 top-[45px] bg-white border-[#62909F] border-[1px] text-[15px]" ref={popupRef}>
                                    <Link href="/make-agreements">
                    ...
                    <div className="pt-10 flex justify-between gap-x-5">
                        ...
                        <div className="w-full max-w-[367px] bg-[#386A8B] border-2 border-[#386A8B] p-5 text-white border-2">
                            ...
                            <h1 className="font-semibold">Total agreements</h1>
                        ...
                        <div className="w-full max-w-[367px] border-2 border-[#386A8B] p-5">
                            ...
                            <h1 className="font-semibold">Closed agreements</h1>
                        ...
                        <div className="w-full max-w-[367px] border-2 border-[#386A8B] p-5">
                            ...
                            <h1 className="font-semibold">Open agreements</h1>
                            <h1 className="font-bold text-[32px] mt-6 mb-8">1</h1>
                                ...
                                <div className="px-10 py-5 grid grid-cols-2 gap-x-10">
                                    <div>
                                        <div className="max-w-[30rem] text-center pt-20 text-[#4B4B4B]">
                                            <h1 className='font-bold mb-10'>You have no previous agreements</h1>
                                            <p>Create a new prospect by through the Agreements manager dropdown</p>
                                            <p>Go to Agreements manager &gt; Add new agreement.</p>
                                        </div>
                                    </div>
                                    <figure>
