...
const Table = () => {
          ...
          <div className="flex justify-between">
            ...
            <div className="mr-10">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                <path d="M3 7H21" stroke="#386A8B" stroke-width="1.5" stroke-linecap="round"/>
                <path d="M6 12H18" stroke="#386A8B" stroke-width="1.5" stroke-linecap="round"/>
                <path d="M10 17H14" stroke="#386A8B" stroke-width="1.5" stroke-linecap="round"/>
              </svg>
  ...
  <thead>
    <tr>
      <th className=" text-left px-8  "> 
      <span className="flex">
          <span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
          <rect x="0.5" y="0.5" width="20" height="20" rx="5.5" fill="white" stroke="#54A4CC"/>
          </svg> </span>
           <span className="ml-2"> Agreement ID</span> 
          <span className="py-1 ml-1">
              <span className="" ><svg xmlns="http://www.w3.org/2000/svg" width="14" height="9" viewBox="0 0 14 9" fill="none">
              <path d="M4.08398 2.91667L7.00065 0L9.91732 2.91667H4.08398Z" fill="black"/>
              </svg></span>
              <span className="">
                <svg xmlns="http://www.w3.org/2000/svg"  className="ml-1"  width="7" height="4" viewBox="0 0 6 4" fill="none">
                <path d="M0.0839844 0.833496L3.00065 3.75016L5.91732 0.833496H0.0839844Z" fill="#B1B1B4"/>
                </svg>
              </span>
        </span> 
      </span>
