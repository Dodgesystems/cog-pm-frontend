                ...
                <section className="mt-5 pr-5">
                    <div className="flex">
                        <div className="relative ml-auto">
                            <button className="bg-[#386A8B] text-white rounded-[4px] px-6 py-2 ml-auto" onClick={togglePopupHandler}>Marketplace manager</button>
                    ...
                    <div className="pt-10 flex justify-between gap-x-5">
                        ...
                        <div className="w-full max-w-[367px] bg-[#386A8B] border-2 border-[#386A8B] p-5 text-white border-2">
                            ...
                            <h1 className="font-semibold">Listed Properties</h1>
                        ...
                        <div className="w-full max-w-[367px] border-2 border-[#386A8B] p-5">
                            ...
                            <h1 className="font-semibold">Inspections</h1>
                                ...
                                <div className="px-10 py-5 grid grid-cols-2 gap-x-10">
                                    <div>
                                        <div className="max-w-[30rem] text-center pt-20 text-[#4B4B4B]">
                                            <h1 className='font-bold mb-10'>You have no previous listing notifications</h1>
                                            <p>Create a new listing through the Marketplace manager dropdown</p>
                                            <p>Go to Marketplace manager &gt; View/edit listings.</p>
                                        </div>
                                    </div>
                                    <figure>
