    ...
    return (
        <Dashboard>
            <main className="p-10 flex-1">
                ...
                <section className="border-[1px] border-[#62909F] py-16 px-5 ml-5 mt-10 flex gap-x-24">
                    <div>
                        {
...
const PropertyDetails = ({ dispatch }) => {
    ...
    return (
        <div className="border-[1px] border-[#62909F] p-6 flex-1 max-w-[600px]">
            <div>
                <h1 className="font-bold text-[20px] text-[#4B4B4B] mb-3">Property details</h1>
                <p className="text-[#B1B1B4] text-[15px]">Kindly select the property that you want to send an offer for.</p>
    ...
    return (
        <div className="border-[1px] border-[#62909F] p-6 flex-1 max-w-[600px]">
            <div>
                ...
                <p className="text-[#B1B1B4] text-[15px]">Kindly select the prospect that you want to send an offer to.</p>
                <div className="mt-10 flex gap-x-5 h-[300px]">
                    <div className="bg-[#19191A] h-[6px] w-[6px] mt-2"></div>
                    <div>
    ...
    return (
        <div className="border-[1px] border-[#62909F] p-6 flex-1 max-w-[600px]">
            <div>
                ...
                <p className="text-[#B1B1B4] text-[15px]">Kindly enter the property purchase/rental amount that you want to send an offer for.</p>
                <div className="mt-10 flex gap-x-5 h-[300px]">
                    <div className="bg-[#19191A] h-[6px] w-[6px] mt-2"></div>
                    <div>
                        <h2>Enter amount</h2>
    ...
    return (
        <div className="border-[1px] border-[#62909F] p-6 flex-1 max-w-[600px]">
            <div>
                ...
                <p className="text-[#B1B1B4] text-[15px]">Kindly enter the payment date for your offer.
                </p>
                <div className="mt-10 flex gap-x-5 h-[300px]">
                    <div className="bg-[#19191A] h-[6px] w-[6px] mt-2"></div>
                    <div>
    ...
    return (
        <section className="flex gap-x-4 flex-1">
            <div className="border-[1px] border-[#62909F] p-6 flex-1">
                <div>
                    <h1 className="font-bold text-[20px] text-[#4B4B4B] mb-3">Offer Summary</h1>
                    <p className="text-[#B1B1B4] text-[15px]">Kindly select the prospect that you want to send an offer to.</p>
                    <div className="mt-10 flex gap-x-5 h-[300px]">
                        <div className="bg-[#19191A] h-[6px] w-[6px] mt-2"></div>
                        <div>
